...
show prd raze n,m2 where 2020=m3+n:l first (where raze 2020=l+/:m3:sum each m2:distinct desc each raze l {x,/:m[x]}each til count m:where each (2020-min l)>l+/:l)mod count l;
